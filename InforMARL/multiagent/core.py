...
class World(object):
    def __init__(self):
        ...
        # 与 sheep-herding-rl 主项目对接的占位字段：
        # - external_goals=True 时由宿主写入 landmark 位置（apply_external_state），
        #   场景在 reset 中跳过 goal 随机化。
        # - use_shepherd_env=True 时把 obstacles[0] 当作羊群质心，宿主在每个主步刷新。
        # 这两个开关不直接影响 World.step()/integrate_state，仅在场景层语义中生效。
        self.external_goals = False
